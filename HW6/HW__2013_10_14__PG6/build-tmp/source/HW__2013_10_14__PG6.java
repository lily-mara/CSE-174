...
public int importantNumber(int arg1, int arg2, int arg3, int arg4, boolean arg5) {
	/*
...
public boolean importantBoolean(int arg1, int arg2, int arg3, int arg4, boolean arg5) {
	/*
	returns true
	*/
...
public void importantMessage() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "HW__2013_10_14__PG6" };
    if (passedArgs != null) {
