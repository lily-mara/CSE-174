...
public class HW__2013_11_03__PG8 extends PApplet {
...
public void drawRainbowTriangles() {
...
public void drawCirclesToRight(int startX, int y) {
...
public void drawCirclesToLeft(int startX, int y) {
	// Draws a group of 40 circles starting at point (startX, y) and
	// moving forward by 3 pixels, with random color and increasing
	// opacity.
...
public void drawTriangleBackground(int numColumns, int numRows) {
...
public void drawVerticalLineWithCircles(int x) {
...
public void makeBoxesRight(int x, int y) {
...
public void makeBoxesLeft(int x, int y) {
	// Creates a series of boxes starting at position (x, y)
	// and contiuing in a right arc.
int opacity = 250;
int xSpacing = 100;
...
int rectSize = 100;
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#F0F0F0", "HW__2013_11_03__PG8" });
  }
}
